...
$config['mongo_db']['default']['username'] = 'kakou';
$config['mongo_db']['default']['password'] = 'kakou';
$config['mongo_db']['default']['database'] = 'kakou';
...
$config['mongo_db']['recg']['no_auth'] = FALSE;
$config['mongo_db']['recg']['hostname'] = 'localhost';
$config['mongo_db']['recg']['port'] = '27017';
$config['mongo_db']['recg']['username'] = 'kakou';
$config['mongo_db']['recg']['password'] = 'kakou';
$config['mongo_db']['recg']['database'] = 'recg';
$config['mongo_db']['recg']['db_debug'] = TRUE;
$config['mongo_db']['recg']['return_as'] = 'array';
$config['mongo_db']['recg']['write_concerns'] = (int)1;
$config['mongo_db']['recg']['journal'] = TRUE;
$config['mongo_db']['recg']['read_preference'] = NULL;
$config['mongo_db']['recg']['read_preference_tags'] = NULL;
